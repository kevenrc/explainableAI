...
if __name__ == "__main__":
    ...
    output_feature = "RiskPerformance"
    label_encoders = {}
    for cat_col in categorical_features:
        label_encoders[cat_col] = LabelEncoder()
        train[cat_col] = label_encoders[cat_col].fit_transform(train[cat_col])
        test[cat_col] = label_encoders[cat_col].fit_transform(test[cat_col])

    dataset_train = TabularDataset(data=train, cat_cols=categorical_features,
            output_col=output_feature)

    dataset_test = TabularDataset(data=test, cat_cols=categorical_features,
            output_col=output_feature)
